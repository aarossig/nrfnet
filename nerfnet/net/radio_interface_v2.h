...
#ifndef NERFNET_NET_RADIO_INTERFACE_V2_H_
#define NERFNET_NET_RADIO_INTERFACE_V2_H_
...
// The inerface to send/receive packets over.
class RadioInterfaceV2 : public NonCopyable {
 public:
  // Setup the radio interface with the address of this station.
  RadioInterfaceV2(uint32_t address);
...
#endif  // NERFNET_NET_RADIO_INTERFACE_V2_H_
